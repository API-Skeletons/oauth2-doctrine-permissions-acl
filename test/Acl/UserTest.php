...
class UserTest extends AbstractTest
{
    ...
    public function testObjectRepositoryProvider()
    {
        ...
        $this->assertTrue($identity instanceof \ZF\OAuth2\Doctrine\Permissions\Acl\Identity\AuthenticatedIdentity);
        $this->assertTrue($identity->getUser() instanceof \ZFTest\OAuth2\Doctrine\Permissions\Acl\Entity\User);
